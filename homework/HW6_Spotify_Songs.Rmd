...
The mean danceability score is about 0.67, and I would say the distribution is skewed to the left. A left-skewing distribution tells me that there are a few unusually-low danceability scores pulling the mean danceability score down, so the songs in the dataset are actually more danceable than the mean value suggests.  
